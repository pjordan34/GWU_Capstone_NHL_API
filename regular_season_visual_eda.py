...
# print a correlation matrix to look for relationships in the data
    ...
    plt.savefig('data/'+str(season)+'Playoffs_corrPlot.png', bbox_inches='tight',pad_inches=0.5)
    #plt.show()
    plt.clf()
# boxplots by season of goals for and goals against
    fig = plt.figure(figsize=(12, 12))
    plt.suptitle('Goals Scored vs. Goals Allowed per Game by Division'+''+str(season), fontsize=14)
    ...
    plt.savefig('data/'+str(season)+'goalsFA.png', bbox_inches='tight',pad_inches=0.5)
    #plt.show()
    plt.clf()
# violin plots of Save percentage and Shots on Goal Against
    fig = plt.figure(figsize=(12, 12))
    fig.suptitle('Save% vs Shots on Goal Against per Game by Division'+''+str(season), fontsize=14)
    ...
    plt.savefig('data/' + str(season) + 'Save_perc_SOGA.png', bbox_inches='tight', pad_inches=0.5)
    #plt.show()
    plt.clf()
# swarm plots on blocks for and against
    fig = plt.figure(figsize=(12, 12))
    fig.suptitle('Blocks Against vs Blocks for per Game by Division'+''+str(season), fontsize=14)
    ...
    # show and save off the graph
    plt.tight_layout(pad=3.0, w_pad=3.0, h_pad=2.0)
    plt.savefig('data/' + str(season) + 'Blocks_for_A.png', bbox_inches='tight', pad_inches=0.5)
    #plt.show()
    plt.clf()
# swarm plots of weighted shots for and against
    fig = plt.figure(figsize=(12, 12))
    fig.suptitle('Weighted Shots for vs Against per Game by Division'+''+str(season), fontsize=14)
    ...
    plt.tight_layout(pad=3.0, w_pad=3.0, h_pad=2.0)
    # show and save off the graph
    plt.savefig('data/' + str(season) + 'WeightedShots_for_A.png', bbox_inches='tight', pad_inches=0.5)
    #plt.show()
    plt.clf()
# boxplots of Shot percentage and SOG for by season
    fig = plt.figure(figsize=(12, 12))
    fig.suptitle('Shot Percentage vs Shots on Goal_for per Game by Division'+''+str(season), fontsize=14)
    ...
    # show and save off the graph
    plt.tight_layout(pad=3.0, w_pad=3.0, h_pad=2.0)
    plt.savefig('data/' + str(season) + 'Shot_Perc_SOG_for.png', bbox_inches='tight', pad_inches=0.5)
    #plt.show()
    plt.clf()
...
# boxplots for goals for percentage and bar plots for total wins per season
    fig = plt.figure(figsize=(12, 12))
    fig.suptitle('Goals for Percentage per Game vs Team Wins by Division'+''+str(season), fontsize=14)
...
# show and save off the graph
    plt.tight_layout(pad=3.0, w_pad=3.0, h_pad=2.0)
    plt.savefig('data/' + str(season) + 'Goals_for_Percentage_Wins.png', bbox_inches='tight', pad_inches=0.5)
    #plt.show()
    plt.clf()
